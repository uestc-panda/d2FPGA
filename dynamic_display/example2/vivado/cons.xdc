...
##SWITCHES
set_property PACKAGE_PIN B16 [get_ports {bit_sel[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bit_sel[0]}]
set_property PACKAGE_PIN E14 [get_ports {bit_sel[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bit_sel[1]}]
set_property PACKAGE_PIN E13 [get_ports {bit_sel[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {bit_sel[2]}]
set_property PACKAGE_PIN C13 [get_ports {data_in[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data_in[0]}]
set_property PACKAGE_PIN B13 [get_ports {data_in[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data_in[1]}]
set_property PACKAGE_PIN A13 [get_ports {data_in[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {data_in[2]}]
set_property PACKAGE_PIN D14 [get_ports {data_in[3]}]
