...
##SWITCHES
set_property PACKAGE_PIN B16 [get_ports {units[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {units[0]}]
set_property PACKAGE_PIN E14 [get_ports {units[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {units[1]}]
set_property PACKAGE_PIN E13 [get_ports {units[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {units[2]}]
set_property PACKAGE_PIN C13 [get_ports {units[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {units[3]}]
set_property PACKAGE_PIN B13 [get_ports {tens[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tens[0]}]
set_property PACKAGE_PIN A13 [get_ports {tens[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tens[1]}]
set_property PACKAGE_PIN D14 [get_ports {tens[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tens[2]}]
set_property PACKAGE_PIN A14 [get_ports {tens[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {tens[3]}]
set_property PACKAGE_PIN D15 [get_ports rst]
set_property IOSTANDARD LVCMOS33 [get_ports rst]
set_property PACKAGE_PIN B15 [get_ports preset]
